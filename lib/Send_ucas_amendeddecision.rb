class SendUcasAmendeddecision < Struct.new(:personalId, :applicationSchemeCode, :choiceNumber, :courseCode, :campus, :pointOfEntry, :entryYear, :entryMonth, :decisionCode, :offerText, :choice_id, :currentUser)
